...
class EngEncoder(nn.Module):
    def __init__(self, eng_vocab_size, hidden_state_size, dropout_probability = 0.1):
...
class NlDecoder(nn.Module):
    def __init__(self, hidden_state_size, nl_vocab_size, vocab_nl, longest_sentence, dropout_probability=0.1):
